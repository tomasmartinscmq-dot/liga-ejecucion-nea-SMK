...
var FORM_CONFIG = {
  ...
  // ── PDVs DE LA PI ──────────────────────────────────────────
  // tipo: 'hiper' o 'super' — define mínimos en focos
  pdvs: {
  ...
  // ── VARIABLES ──────────────────────────────────────────────
  // tipo: 'multi' = selección múltiple | 'sino' = SI/NO
  // Para tipo 'multi' con mínimos por formato:
  //   minHiper: mínimo de opciones para cumplir en hiper
  //   minSuper: mínimo de opciones para cumplir en super
  //   noneValue: valor que representa "ninguno" (se descuenta del conteo)
  variables: [
    {
      key: 'gameplan',
    ...
    },
    {
      ...
      infoBox: 'Objetivo: 🏪 Hiper: 3 ocasiones · 🛒 Super: 2 ocasiones'
    },
    {
      key: 'nabsadic',
  ...
  // ── UMBRALES DE SCORE ──────────────────────────────────────
  umbrales: {
    alto: 75,   // verde — excelente
    medio: 50   // amarillo — aceptable / rojo si está por debajo
  },
